            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Page de profil</h4>
                    </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="update.php" method="post">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Nom complet</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="<?php echo $admin['fullName']; ?>"
                                                class="form-control p-0 border-0" name="fullName" required=""> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Adresse email</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="email" placeholder="<?php echo $admin['email']; ?>"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" value="password" required="" class="form-control p-0 border-0" name ="password">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Numéro de téléphone</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="<?php echo $admin['phonenum']; ?>"
                                                class="form-control p-0 border-0" name ="phonenum" required="">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Pays</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="<?php echo $admin['country']; ?>"
                                                class="form-control p-0 border-0" name ="country" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-warning" type="submit" name="submit">Mettre à jour profil</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
