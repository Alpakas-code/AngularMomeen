            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Les zones</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="#" class="btn btn-outline-warning" style="text-decoration : none; color : black; font-size : 15px; font-family : Arial" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Ajouter Zone </a>
                        </div>
                <!-- Modal -->
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title me-auto" id="exampleModalLabel">Ajouter Zone</h4>
                    ...
                    $messageStat =$connexion->prepare(" Insert into zone values(NULL,'".$emplacement."',1);");
                    ...
                    ?>
                        ...
                        <h3 class="box-title">List des Zones</h3>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">#</th>
                                            <th class="border-top-0">Emplacement</th>
                                    ...
                                    <tbody>
                                        ...
                                        $clubReq = $connexion->prepare("Select * from zone");
                                        ...
                                        foreach($resu as $r)
                                        {
                                            ...
                                            <td>
                                                <form action="entTreatement.php?idEnt='.$idEnt.'" method="post" class="form">
                                                    <input type="submit" name="deleteZ" value="Delete" class=" btn btn-danger">
                                            ...
                                            ';
                                                ...
                                                <td>
                                                    <form action="entTreatement.php?idEnt='.$idEnt.'" method="post" class="form">
                                                        <input type="submit" name="reactivateZ" value="Réactiver" class=" btn btn-info">
